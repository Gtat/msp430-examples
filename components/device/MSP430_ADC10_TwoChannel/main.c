...
unsigned short Channel1[99];
unsigned short Channel2[99];
int test = 0;

int main(void)
{
  WDTCTL = WDTPW + WDTHOLD;                 // Stop WDT
  ADC10CTL1 = SHS_1 + CONSEQ_3 + INCH_1;    // TA1 trigger sample start
  ...
  ADC10AE0 |= 0x03;                         // P1.1, P1.0 ADC10 option select
